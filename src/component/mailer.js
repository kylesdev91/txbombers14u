  ...
  return (
    ...
    >
      ...
      >
        ...
        <label style={{ color: 'white' }}>Parent Number</label>
        ...
        <label style={{ color: 'white' }}>Player Name</label>
        <input type='text' name='playerName' className='form-control' />

        <label style={{ color: 'white' }}>Player Current Team</label>
        <input type='text' name='playerCurrentTeam' className='form-control' />

        <label style={{ color: 'white' }}>Player Date Of Birth</label>
        <input type='text' name='playerDOB' className='form-control' />

        <label style={{ color: 'white' }}>Player Primary Position</label>
        <input
          type='text'
        ...
        <label style={{ color: 'white' }}>Player Secondary Position</label>
        <input
          type='text'
